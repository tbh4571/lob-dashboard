      ...
      >
        ...
        {sorted.map((step) => (
          ...
          >
            ...
            <Typography variant="body2" fontWeight={600} textAlign="center" sx={{ mt: 1.5, maxWidth: 120 }}>
              {step.name}
            </Typography>
            ...
            {step.status === 'failed' && <Chip label="Failed" size="small" color="error" sx={{ mt: 0.5 }} />}
            {step.status === 'running' && <Chip label="Running" size="small" color="primary" sx={{ mt: 0.5 }} />}
          </Box>
        ))}
      </Box>
